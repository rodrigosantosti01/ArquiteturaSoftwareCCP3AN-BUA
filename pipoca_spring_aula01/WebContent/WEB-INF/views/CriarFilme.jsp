		 ...
		 <div class="${css}">
            ...
            <div class="row">
                <div class="form-group col-md-8">
                    ...
                    <form:errors  path="filme.diretor" cssStyle="color:red"/> 
