    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/pipoca_spring_aula03/index">Hora da Pipoca</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Catálogo</a>
  						  ...
  						  <li><a class="dropdown-item" href="/pipoca_spring_aula03/generos">por Gênero</a></li>
  						   <li><a class="dropdown-item" href="/pipoca_spring_aula03/popularidade">por Popularidade</a></li>
